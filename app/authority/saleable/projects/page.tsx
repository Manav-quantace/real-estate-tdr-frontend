//app/authority/saleable/projects/page.tsx
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold">Saleable Projects</h1>
                    <p className="text-muted-foreground text-sm">
                        Government-managed saleable housing projects
                    </p>
                </div>

                <Link
                    href="/authority/saleable/projects/new"
            ...
            <div className="grid gap-4">
                {projects.map(p => (
                    <Link
                        key={p.projectId}
                        href={`/authority/saleable/projects/${p.projectId}`}
                ...
                {projects.length === 0 && (
                    <div className="text-sm text-muted-foreground">
                        No saleable projects created yet.
                    </div>
                )}
            </div>
        </div>
